namespace OffsetGenerator.Common.Helpers;
...
public class Logger
{
    ...
    private static List<LogInfo> _logInfoList = new List<LogInfo>()
    {
    ...
    {
        var logInfo = _logInfoList.Where(x => x.Type.Equals(logType)).First();
